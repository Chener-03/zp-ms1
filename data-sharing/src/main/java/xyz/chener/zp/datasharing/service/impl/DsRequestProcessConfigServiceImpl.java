...
/**
 * (DsRequestProcessConfig)表服务实现类
 *
 * @author makejava
 * @since 2023-04-02 10:24:08
 */
@Service
public class DsRequestProcessConfigServiceImpl extends ServiceImpl<DsRequestProcessConfigDao, DsRequestProcessConfig> implements DsRequestProcessConfigService {
